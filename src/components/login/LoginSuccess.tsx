...
export const LoginSuccess = () => {
  const [search] = useCustomSearchParams<{ email: string }>();
  ...
  return (
    <Card shadow="sm" p="lg" radius="md" mt="lg" withBorder>
      <Stack spacing="sm" align="center">
        ...
        <Text align="center">
          Check your inbox! If we found your email address ({search.email})
          you'll have a link to login and access your account.
        </Text>
